<?php
// session_start();
if($_SESSION["level"] != 1 || empty($_SESSION["user"]) ){
	session_destroy();
	...
	<div class="mdl-layout__drawer-button"><i class="material-icons">menu</i></div>       
      ...
      <div id="divNav" class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="#" onclick="openFrame('add_palestra.php','Aggiungi palestre')"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">people</i>Aggiungi palestra</a>
        <!--  <a class="mdl-navigation__link" href="#" onclick="openFrame('mie_palestre.php','Le mie palestre')"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Le mie palestre</a>-->
          <a class="mdl-navigation__link" href="#" onclick="openFrame('lista_palestre.php','Tutte le palestre')"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Tutte le palestre</a>
